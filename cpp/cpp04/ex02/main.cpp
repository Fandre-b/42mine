...
/*   Updated: 2025/04/21 12:57:45 by fandre-b         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	// uncomment the following to show that the AAnimal constructor is
	...
	{
		std::cout << std::endl;
		std::cout << "AAnimal _type: " << meta[i]->getType() << std::endl;
		meta[i]->makeSound();
		std::cout << std::endl;
	}
	std::cout << std::endl;
